...
var corsConfig = cors.Config{AllowOrigins: "https://bench.invalid", AllowMethods: "GET,POST"}
...
func scenarios() []scenario {
	list := []scenario{
		...
		{
			name: "not_found_default", method: "GET", uri: "/missing", wantStatus: 404, wantBody: "Cannot GET /missing",
